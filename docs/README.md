# Documentación de Demostración de Web APIs
...
| [`product/business-model.md`](product/business-model.md)       | ¿Por qué existe / cómo aporta valor? | Para entender el propósito      |
...
- **`architecture/`** describe **este** proyecto en concreto (cómo está montado,
  qué stack usa, cómo se ve).
- **`conventions/`** describe **reglas reusables** de cómo trabajamos (cómo
  estructuramos las vistas, cómo aplicamos el sistema de diseño, cómo probamos) —
  transversales a cualquier ejemplo.
