...
¡Gracias por tu interés en contribuir a **Demostración de Web APIs**! Esta guía describe el flujo de trabajo, los estándares de código y el proceso de Pull Requests.
...
- Indentación y estilo definidos por [`.editorconfig`](.editorconfig) y Prettier.
- Codificación UTF-8, finales de línea LF, 2 espacios de indentación.

### Nombrado

- HTML/CSS/JavaScript: `camelCase` para variables y funciones JS, `kebab-case` para
  clases CSS y nombres de archivo.
...
- No hay tests automatizados: la verificación es **manual y por navegador**.
- Antes de abrir el PR, recorre el [checklist manual](docs/conventions/testing.md)
  (carga sin errores, temas claro/oscuro, feature detection, responsive, teclado).
